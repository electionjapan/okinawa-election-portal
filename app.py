...
""",
    ...
    st.markdown('<div class="portal-kicker">OKINAWA ELECTION PORTAL · v0.9.32 · LIVE SHEET</div>', unsafe_allow_html=True)
...
""",
    ...
    st.markdown(
        '<div class="portal-foot">Okinawa Election Portal — v0.9.32</div>',
        unsafe_allow_html=True,
    )
